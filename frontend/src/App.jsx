...
export default function App() {
  ...
  const css = `
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    @media (max-width: 600px) { .ri-grid { grid-template-columns: 1fr; } }
    ...
    .ri-weaknesses .ri-list-card-title { color: #FB923C; }
    .ri-weaknesses .ri-list-dot { background: #FB923C; }
              ...
              <div className="ri-terminal-body" ref={logRef}>
                ...
                {loading && (
                  <div className="ri-log-line">
                    ...
                    <span className="ri-log-text">
                      <span className="ri-cursor" />
                    </span>
                  </div>
                )}
              </div>
